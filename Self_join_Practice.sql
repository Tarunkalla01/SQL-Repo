...
-- in referance of manager
select mg.emp_id, mg.emp_name ,mg.manager_id from employee as mg;

-- self join 
select emp.emp_id,emp.emp_name, emp.manager_id ,emp.salary , mg.emp_id , mg.emp_name ,  mg.salary from employee as emp join employee as mg where emp.manager_id = mg.emp_id;
